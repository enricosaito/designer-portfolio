  ...
  return (
    <div className="fixed inset-0 bg-yellow-300 dark:bg-purple-900 transition-colors duration-300 flex items-center justify-center">
      <div className="relative">
        ...
        {/* Decorative elements */}
        <div className="absolute -top-6 -right-6 w-14 h-14 bg-pink-500 dark:bg-teal-400 border-4 border-black dark:border-white shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] dark:shadow-[4px_4px_0px_0px_rgba(255,255,255,1)] rounded-full animate-spin" />
